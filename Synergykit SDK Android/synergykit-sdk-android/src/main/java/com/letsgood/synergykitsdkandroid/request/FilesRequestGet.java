...
public class FilesRequestGet extends SynergykitRequest {

	/* Attributes */
	private SynergykitConfig config;
	private FilesResponseListener listener;
	...
	/* Listener setter */
	public void setListener(FilesResponseListener listener){
	...
	protected void onPostExecute(Object object) {
		...
		if(dataHolder.statusCode>= HttpStatus.SC_OK && dataHolder.statusCode < HttpStatus.SC_MULTIPLE_CHOICES){
			listener.doneCallback(dataHolder.statusCode, (SynergykitFile[])dataHolder.objects);
		}else{
