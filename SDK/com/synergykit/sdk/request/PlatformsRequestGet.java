...
public class PlatformsRequestGet extends SynergyKITRequest{

	/* Attributes */
	private SynergyKITConfig config;
	private PlatformsResponseListener listener;
	...
	/* Listener setter */
	public void setListener(PlatformsResponseListener listener){
	...
	protected void onPostExecute(Object object) {
		...
		if(dataHolder.statusCode>= HttpStatus.SC_OK && dataHolder.statusCode < HttpStatus.SC_MULTIPLE_CHOICES){
			listener.doneCallback(dataHolder.statusCode, (SynergyKITPlatform[]) dataHolder.objects);
		}else{
